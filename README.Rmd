...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/JointAI)](https://cran.r-project.org/package=JointAI)
...
The package **JointAI** provides joint analysis and imputation of linear regression models,
