...
This allows changing colour, line type and -width, limits, etc.
...
set `subset = c(analysis_main = FALSE, other_models = TRUE)` (after re-estimating
...
```{r message = FALSE}
densplot(mod13c, subset = list(other = c('beta[4]', 'beta[5]')), nrow = 1)
```
...
```{r, fig.width = 7, fig.height = 2.5, out.width = '100%'}
