...
# select all imputed values for 'WC' (4th column of M_levelone)
sub3 <- grep('M_levelone\\[[[:digit:]]+,4\\]', parameters(mod13d), value = TRUE)
sub3
...
rs <- grep('^b_bmi_ID\\[[[:digit:]]+,2\\]$', colnames(mod13e$MCMC[[1]]), value = T)
