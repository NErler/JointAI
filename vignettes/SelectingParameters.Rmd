...
#> (Intercept)  81.737 9.9071 62.317 100.78     0.0000   1.023 0.0577
#> genderfemale  0.213 2.5267 -4.562   4.93     0.9133   1.050 0.0577
#> WC            0.301 0.0755  0.136   0.45     0.0000   0.999 0.0577
#> alc>=1        6.157 2.5434  1.197  11.01     0.0333   1.009 0.0671
#> creat         7.781 7.5670 -5.807  23.68     0.2933   1.052 0.0634
#> 
#> Posterior summary of residual std. deviation:
#>           Mean    SD 2.5% 97.5% GR-crit MCE/SD
#> sigma_SBP 14.4 0.756 13.1  15.9    1.05 0.0577
#> 
#> 
#> MCMC settings:
#> Iterations = 101:200
...
#> 
#>              Point est. Upper C.I.
#> (Intercept)       1.003      1.023
#> genderfemale      1.012      1.050
#> WC                0.997      0.999
#> alc>=1            1.000      1.009
#> creat             1.018      1.052
#> sigma_SBP         1.012      1.055
#> 
#> Multivariate psrf
#> 
#> 1.03
...
MC_error(lm5)
#>                est   MCSE    SD MCSE/SD
#> (Intercept)  81.74 0.5720 9.907   0.058
#> genderfemale  0.21 0.1459 2.527   0.058
#> WC            0.30 0.0044 0.075   0.058
#> alc>=1        6.16 0.1707 2.543   0.067
#> creat         7.78 0.4798 7.567   0.063
#> sigma_SBP    14.38 0.0437 0.756   0.058
```
...
#> 
#>                     Point est. Upper C.I.
#> alc: (Intercept)         1.096      1.306
#> alc: genderfemale        1.076      1.254
#> alc: WC                  1.045      1.143
#> alc: creat               1.023      1.089
#> creat: (Intercept)       1.004      1.024
#> creat: genderfemale      1.005      1.017
#> creat: WC                1.001      1.014
#> WC: (Intercept)          0.997      0.997
#> WC: genderfemale         1.001      1.001
#> sigma_creat              1.009      1.029
#> sigma_WC                 1.020      1.081
#> 
#> Multivariate psrf
#> 
#> 1.13
