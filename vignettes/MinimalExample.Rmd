...
At the end of the output, a summary of the missing values in all variables
involved in the model is given. To avoid lengthy output, this part can be
omitted by setting `missinfo = FALSE`.
