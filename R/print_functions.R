...
list_impmodels <- function(object) {
  ...
  for (i in seq_along(object$meth)) {
    ...
    if(object$meth[i] %in% c("norm", "lognorm")) {
      type <- switch(object$meth[i],
                     ...
                     lognorm = list(lab = 'norm', name = "Log-normal"))
      ...
      cat(paste0("* Regression coefficients: \n",
          ...
          "] (normal prior(s) with mean ", object$data_list[[paste0("mu_reg_", type$lab)]],
          " and precision ", object$data_list[[paste0("tau_reg_", type$lab)]], ")\n"))
      cat(paste0("* Pecision of '", names(object$meth)[i], "':\n",
          tab(), "tau_", names(object$meth)[i], " (Gamma prior with scale parameter ",
    ...
    if(object$meth[i] %in% c("gamma")) {
      ...
      cat(paste0("* Regression coefficients: \n",
                 ...
                 print_seq(object$K_imp[names(object$meth)[i], "start"],
                           object$K_imp[names(object$meth)[i], "end"]),
                 "] (normal prior(s) with mean ", object$data_list$mu_reg_gamma,
    ...
    if(object$meth[i] %in% c("beta")) {
      ...
      cat(paste0("* Regression coefficients: \n",
                 ...
                 print_seq(object$K_imp[names(object$meth)[i], "start"],
                           object$K_imp[names(object$meth)[i], "end"]),
                 "] (normal prior(s) with mean ", object$data_list$mu_reg_beta,
                 " and precision ", object$data_list$tau_reg_beta, ")\n"))
      cat(paste0("* tau_", names(object$meth)[i], " (Gamma prior with scale parameter ",
    ...
    if(object$meth[i] == "logit") {
      ...
      cat(paste0("* Regression coefficients: \n",
                 ...
                 print_seq(object$K_imp[names(object$meth)[i], "start"],
                           object$K_imp[names(object$meth)[i], "end"]),
                 "] (normal prior(s) with mean ", object$data_list$mu_reg_logit,
                   ...
                   cat(paste0(tab(), "- '",
                              ...
                              print_seq(object$K_imp[attr(object$refcats[[names(object$meth)[i]]],
                                        ...
                                        object$K_imp[attr(object$refcats[[names(object$meth)[i]]],
                                                          "dummies")[j],  "end"]),
                              "] (normal prior(s) with mean ", object$data_list$mu_reg_multinomial,
    ...
    if(object$meth[i] == "cumlogit") {
      ...
      cat(paste0("* Reference category: '", object$refcats[[names(object$meth)[i]]], "'\n"))
      cat(paste0("* Regression coefficients (without intercept): \n",
                 tab(), "alpha[",
                 print_seq(object$K_imp[names(object$meth)[i], "start"],
                           object$K_imp[names(object$meth)[i], "end"]),
                 "] (normal prior(s) with mean ", object$data_list$mu_reg_ordinal,
      ...
      cat(paste0("* Intercepts:\n",
                 ...
                 "[1] (normal prior with mean ",  object$data_list$mu_delta_ordinal,
      ...
      cat(paste0("* Increments:\n",
                 ...
                 "] (normal prior(s) with mean ",  object$data_list$mu_delta_ordinal,
                 " and precision ", object$data_list$tau_delta_ordinal, ")\n"))
    }
  }
}
