...
# @export
impmodel_multinomial <- function(varname, dest_col, Xc_cols, par_elmts, par_name, dummy_cols, ncat, refcat, ...){
...
# @param par_name name of the parameter
# @export
impprior_multinomial <- function(varname, par_elmts, par_name, ...){
