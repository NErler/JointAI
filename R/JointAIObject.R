...
#'                             \code{family} and \code{link} for GLM-type models}
...
#' \item{\code{random}}{a list of the random effects formulas of the sub-model(s)
#'                     for which the use had specified a formula}
#' \item{\code{Mlist}}{a list (for internal use) containing the data and
#'                     information extracted from the data and model formulas,
#'                     split up into
#'       \itemize{
#'         \item a list of design matrices, one for each level of the data (\code{M})
...
#'               centring and scaling parameters for the data (\code{scale_pars})
...
#' \item{\code{mcmc_settings}}{a list containing MCMC sampling related information
#'                             with elements
#'      \itemize{
...
#'      \item{\code{parallel}: }{a logical indicator whether parallel sampling was used}
#'      \item{\code{n.cores}: }{the number of cores used in parallel sampling}
#'      }}
#' \item{\code{monitor_params}}{the named list of parameter groups to be monitored}
...
#' \item{\code{info_list}}{a list with information used to write the imputation model syntax}
#' \item{\code{coef_list}}{a list relating the regression coefficient vectors
#'                         used in the JAGS model to the names of the corresponding
#'                         covariates}
